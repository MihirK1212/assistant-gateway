...
which should point to the JSON gateway config file.

Usage:
    # Set the env var before starting celery
    export GATEWAY_CONFIG_PATH="/path/to/myapp.json"
...
launcher which sets up the environment and launches both FastAPI
...
from assistant_gateway.runner.parse_config import parse_config  # noqa: E402

_result = parse_config(_config_path)
config = _result.gateway_config
